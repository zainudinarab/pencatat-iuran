            ...
            <tbody>
                @foreach($setorans as $setoran)
                    <tr>
                        ...
                        <td>
                            <span class="badge badge-warning">{{ ucfirst($setoran->status) }}</span>
                        </td>
                        <td>
                            {{-- If status is 'pending', allow confirmation --}}
                            @if($setoran->status == 'pending')
                            <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#confirmModal" data-id="{{ $setoran->id }}" data-petugas="{{ $setoran->petugas_id }}" data-amount="{{ $setoran->total_amount }}">Konfirmasi</button>
            ...
            <div class="modal-body">
                <form id="confirmSetoranForm" method="POST" action="">
                    ...
                    <div class="form-group">
                        ...
                        <label class="radio-inline"><input type="radio" name="status" value="confirmed" checked> Diterima</label>
                        <label class="radio-inline"><input type="radio" name="status" value="ditolak"> Ditolak</label>
                    </div>
...
const form = document.getElementById('confirmSetoranForm');
        ...
        confirmModal.addEventListener('show.bs.modal', function (event) {
           ...
           // Set URL action form
    const actionUrl = `/setoran/${setoranId}/konfirmasi`;  // Sesuaikan dengan URL rute di aplikasi kamu
