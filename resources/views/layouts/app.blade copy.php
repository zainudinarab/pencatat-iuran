                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        @auth
                            ...
                            <ul class="navbar-nav">
                                ...
                                @if ($user->can('profils-view'))
                                <li class="nav-item">
                                    <a class="nav-link" href="/profile">Profil</a>
                                </li>
                                @endif
                                @if ($user->can('residents-view'))
                                <li class="nav-item">
                                    <a class="nav-link" href="/residents">Data Warga</a>
                                </li>
                                @endif
                                @if ($user->can('penarikans-view'))
                                <li class="nav-item">
                                    <a class="nav-link" href="/penarikan">Penarikan</a>
                            </li>
                            @endif
                            @if ($user->can('setorans-view'))
                            <li class="nav-item">
                                <a class="nav-link" href="/setoran">Setoran</a>
                        </li>
                        @endif
                        <li><a class="nav-link" href="{{ route('users.index') }}">Manage Users</a></li>
                        @if ($user->can('konfirmasi_setorans-view'))
                        <li class="nav-item">
                            <a class="nav-link" href="/confirm-setoran">Confirm Setoran</a>
                            </li>
                            @endif
                            @if ($user->can('pengeluaran-view'))
                            <li class="nav-item">
                                <a class="nav-link" href="/pengeluaran">Pengeluaran</a>
                        </li>
                        @endif
                        @if ($user->can('saldo-view'))
                        <li class="nav-item">
                            <a class="nav-link" href="/saldo">Saldo</a>
                    </li>
                    @endif
